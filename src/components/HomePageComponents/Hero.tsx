    ...
    return (
        <div className=''>
            ...
            <div className='heroTopBackgroundHold flex'>
                <div className="herobg1 w-full bg-white dark:bg-slate-900 h-24">
                ...
                <div className="heroChildOneHold flex-col flex justify-center items-center">
                    <div className="heroChild1">
                        ...
                        <div className="heroInnerChild1 flex flex-col gap-4">
                            ...
                            <button className='flex justify-center items-center mt-8 w-36 h-10 rounded bg-black dark:bg-slate-100 dark:text-slate-900 text-white font-semibold transition-all ease-in-out duration-500 hover:bg-transparent hover:border hover:text-black dark:hover:text-slate-100 dark:hover:bg-slate-900 border-black dark:border-slate-100' onClick={() => window.scrollTo({
                                behavior: "smooth",
                                top : 1100
                            })}>Learn More</button>
                        </div>
                    ...
                    <div className="heroStatsHold bg-white dark:bg-slate-900 text-black dark:text-slate-100 flex justify-center items-center lg:gap-20 gap-12 md:gap-8 w-full h-28 mt-16 sm:pl-0 sm:pr-0 pl-3 pr-3">
                        <div className='heroStat1 pt-3 pb-3 font-semibold flex flex-col'>
                            <p className='md:text-2xl text-xl font-normal interFont'>10K+</p>
                            <p className='text-gray-500 dark:text-slate-400 font-normal text-xs md:text-sm lg:text-base interFont'> Total</p>
                            <p className='interFont text-gray-500 dark:text-slate-400 text-xs md:text-sm lg:text-base font-medium'>Digital Assets</p>
                        </div>

                        <div className='heroStat1 pt-3 pb-3 font-semibold flex flex-col'>
                            <p className='md:text-2xl text-xl font-normal interFont'>150+</p>
                            <p className='text-gray-500 dark:text-slate-400 font-normal text-xs md:text-sm lg:text-base interFont'>International Exchanges</p>
                            <p className='interFont text-gray-500 dark:text-slate-400 text-xs md:text-sm lg:text-base font-medium'>All Over The World</p>
                        </div>

                        <div className='heroStat1 pt-3 pb-3 font-semibold flex flex-col'>
                            <p className='md:text-2xl text-xl font-normal interFont'>$5B+</p>
                            <p className='text-gray-500 dark:text-slate-400 font-normal text-xs md:text-sm lg:text-base interFont'>Total Number Of Funds</p>
                            <p className='interFont text-gray-500 dark:text-slate-400 text-xs md:text-sm lg:text-base font-medium'>Secured With Us</p>
                        </div>
                    </div>
